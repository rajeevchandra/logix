        ...
        <div className="w-full max-w-md">
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="flex items-center gap-3">
              <Link href="/login" className="text-[14px] font-medium text-gray-500 hover:text-gray-700 transition-colors">Login</Link>
              <Link href="/signup" className="text-[14px] font-semibold text-gray-900">Sign Up</Link>
            </div>
          </div>

          <h2 className="text-2xl font-bold text-gray-900 mb-1.5">Master the logic</h2>
          <p className="text-gray-500 text-[14px] mb-8">Join the world's most intuitive academic platform for modern learners.</p>
          ...
          <Link href="/dashboard" className="block w-full bg-primary text-white text-center font-semibold text-[14px] py-3 rounded-xl hover:bg-primary/90 transition-colors mb-5">
            Create Account
          </Link>
          ...
          <div className="text-center space-y-3">
            <p className="text-[13px] text-gray-500">Already have an account? <Link href="/login" className="text-primary font-medium hover:underline">Log In</Link></p>
